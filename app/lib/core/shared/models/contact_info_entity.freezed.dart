...
mixin _$ContactInfoEntity {
  ...
  /// Create a copy of ContactInfoEntity
...
class _$ContactInfoEntityImpl implements _ContactInfoEntity {
  ...
  @override
  String toString() {
    return 'ContactInfoEntity(userName: $userName, userPhone: $userPhone)';
  }
...
abstract class _ContactInfoEntity implements ContactInfoEntity {
  const factory _ContactInfoEntity(
      {required final String userName,
      required final String userPhone}) = _$ContactInfoEntityImpl;
