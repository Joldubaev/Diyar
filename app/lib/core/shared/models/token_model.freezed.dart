...
abstract class $TokenModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String role, String refreshToken, String accessToken});
}
...
class _$TokenModelImpl implements _TokenModel {
  ...
  @override
  String toString() {
    return 'TokenModel(role: $role, refreshToken: $refreshToken, accessToken: $accessToken)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, role, refreshToken, accessToken);
