...
import 'package:diyar/features/auth/presentation/pages/splash/splash_page.dart'
    as _i34;
import 'package:diyar/features/cart/cart.dart' as _i44;
...
class DeliveryFormRouteArgs {
  ...
  final List<_i44.CartItemEntity> cart;
...
/// generated route for
/// [_i17.OrderMapPage]
class OrderMapRoute extends _i41.PageRouteInfo<OrderMapRouteArgs> {
  OrderMapRoute({
    _i42.Key? key,
    required List<_i45.CartItemEntity> cart,
    required int totalPrice,
    List<_i41.PageRouteInfo>? children,
  }) : super(
          OrderMapRoute.name,
...
class OrderMapRouteArgs {
  ...
  final List<_i45.CartItemEntity> cart;
...
/// generated route for
/// [_i19.PinCodePage]
class PinCodeRoute extends _i41.PageRouteInfo<void> {
  const PinCodeRoute({List<_i41.PageRouteInfo>? children})
      : super(
          PinCodeRoute.name,
          initialChildren: children,
        );
  ...
  static _i41.PageInfo page = _i41.PageInfo(
    name,
    builder: (data) {
      return const _i19.PinCodePage();
    },
  );
}

/// generated route for
/// [_i20.ProductDetailPage]
class ProductDetailRoute extends _i41.PageRouteInfo<ProductDetailRouteArgs> {
  ProductDetailRoute({
    _i42.Key? key,
    required _i47.FoodEntity food,
    int? quantity,
    List<_i41.PageRouteInfo>? children,
  }) : super(
...
class RessetPasswordRoute extends _i41.PageRouteInfo<RessetPasswordRouteArgs> {
  ...
  static _i41.PageInfo page = _i41.PageInfo(
    ...
    builder: (data) {
      ...
      return _i23.RessetPasswordPage(
        key: args.key,
        phone: args.phone,
      );
    },
...
class RestorantRoute extends _i41.PageRouteInfo<void> {
  ...
  static _i41.PageInfo page = _i41.PageInfo(
    name,
    builder: (data) {
      return const _i24.RestorantPage();
    },
  );
}
...
class SearchMenuRoute extends _i41.PageRouteInfo<void> {
  ...
  static _i41.PageInfo page = _i41.PageInfo(
    name,
    builder: (data) {
      return const _i26.SearchMenuPage();
    },
  );
}

/// generated route for
/// [_i27.SecondOrderPage]
class SecondOrderRoute extends _i41.PageRouteInfo<SecondOrderRouteArgs> {
  SecondOrderRoute({
    _i42.Key? key,
    required List<_i45.CartItemEntity> cart,
    required int dishCount,
...
/// generated route for
/// [_i28.SecurityPage]
class SecurityRoute extends _i41.PageRouteInfo<void> {
  const SecurityRoute({List<_i41.PageRouteInfo>? children})
      : super(
          SecurityRoute.name,
          initialChildren: children,
        );
  ...
  static _i41.PageInfo page = _i41.PageInfo(
    name,
    builder: (data) {
      return const _i28.SecurityPage();
    },
  );
}

/// generated route for
/// [_i29.SetNewPinCodePage]
class SetNewPinCodeRoute extends _i41.PageRouteInfo<void> {
  const SetNewPinCodeRoute({List<_i41.PageRouteInfo>? children})
      : super(
  ...
  static _i41.PageInfo page = _i41.PageInfo(
    name,
    builder: (data) {
      return const _i29.SetNewPinCodePage();
    },
  );
}
...
class SignUpOtpRoute extends _i41.PageRouteInfo<SignUpOtpRouteArgs> {
  SignUpOtpRoute({
    _i42.Key? key,
    required _i50.UserEntities user,
    List<_i41.PageRouteInfo>? children,
  }) : super(
          SignUpOtpRoute.name,
...
class UserPickupDetailRoute
  ...
  static _i41.PageInfo page = _i41.PageInfo(
    ...
    builder: (data) {
      ...
      return _i38.UserPickupDetailPage(
        key: args.key,
        order: args.order,
      );
    },
