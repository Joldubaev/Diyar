...
class _SetNewPinCodePageState extends State<SetNewPinCodePage> {
  ...
  void _validatePins() {
    if (_enteredPin != _confirmPin) {
      ...
      context.read<SecurityCubit>().setPinCode(_confirmPin);
    }
  }
        ...
        listeners: [
          BlocListener<SecurityCubit, SecurityState>(
            listener: (context, state) {
              ...
              if (state is SecurityPinCodeSetSuccess) {
                log("PIN code set successfully. Getting navigation route.");
                context.read<PinCodeCubit>().getNavigationRoute();
              } else if (state is SecurityPinCodeSetFailure) {
