...
import 'package:diyar/features/auth/presentation/presentation.dart' as auth_presentation;
...
class _PinCodePageState extends State<PinCodePage> {
  ...
  void _onExitPressed(bool isLoadingPin, bool isAuthenticatingBiometric) {
    ...
    AuthDialogs.showExitDialog(context, () {
      context.read<auth_presentation.SignInCubit>().logout();
    });
  }
    ...
    return Scaffold(
      ...
      body: MultiBlocListener(
        listeners: [
          ...
          BlocListener<auth_presentation.SignInCubit, auth_presentation.SignInState>(
            listener: (context, state) {
              if (state is auth_presentation.LogoutSuccess) {
                context.router.replace(const SignInRoute());
              } else if (state is auth_presentation.LogoutFailure) {
