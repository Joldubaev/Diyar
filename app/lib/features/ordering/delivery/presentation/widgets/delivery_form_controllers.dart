...
class DeliveryFormControllers {
  ...
  DeliveryFormControllers({
    ...
    String? initialComment,
        ...
        apartmentController = TextEditingController(text: initialApartment ?? ''),
        intercomController = TextEditingController(text: initialIntercom ?? ''),
        floorController = TextEditingController(text: initialFloor ?? ''),
        entranceController = TextEditingController(text: initialEntrance ?? ''),
